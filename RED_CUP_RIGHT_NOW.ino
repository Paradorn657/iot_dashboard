...
const char* mqtt_Client = "ce0cf211-6af5-4492-b1c4-a2477b0aea16";
const char* mqtt_username = "i8i9mPNJ37fUo75ZHHs3yieEXQ1bezLB";
const char* mqtt_password = "D6MFarXHK38S4DVMo8ePFeHpiiWNHvpi";
...
int moduleId = 1;  // Unique ID for this module (you can set this based on module)
